...
| 15 | Solvability indicator & game-finished dialog | `App.tsx` `gameIsSolvable`, finished Dialog, one-time elapsed capture | 14 | §3.6, §5.13 | Play to an empty tray both in a solvable and an unsolvable state, confirm correct dialog + duration |
